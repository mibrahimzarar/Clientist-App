...
import { useFreelancerInvoice, useUpdateInvoice, useFreelancerClients } from '../../../../../src/hooks/useFreelancer'
import { DatePickerInput } from '../../../../../src/components/ui/DatePickerInput'
import { FreelancerInvoiceItem, InvoiceStatus } from '../../../../../src/types/freelancer'

export default function EditInvoicePage() {
    const { id } = useLocalSearchParams()
    const { data: invoice, isLoading: isLoadingInvoice } = useFreelancerInvoice(id as string)
    ...
    useEffect(() => {
        if (invoice) {
            ...
            // Transform items to remove quantity field for display
            ...
            setSelectedClientName(invoice.client?.full_name || '')
        }
    }, [invoice])
            ...
            <ScrollView style={styles.content} contentContainerStyle={styles.scrollContent}>
                ...
                >
                    {updateInvoiceMutation.isPending ? (
                        ...
                        <Text style={styles.submitButtonText}>Update Invoice</Text>
                    )}
                </TouchableOpacity>
            </ScrollView>
