  ...
  const menuItems = [
    {
      ...
      href: '/(verticals)/freelancer/dashboard',
      color: '#3B82F6'
    },
    {
      title: 'Projects',
    ...
    },
    {
      ...
      icon: 'time' as const,
      href: '/(verticals)/freelancer/time-tracking',
      color: '#EF4444'
    },
    {
      title: 'Proposals',
      description: 'Send project proposals',
      icon: 'document-text' as const,
      href: '/(verticals)/freelancer/proposals',
      color: '#6B7280'
    }
  ]
  ...
  const quickActions = [
    {
      ...
      description: 'Switch to Travel Agent or Service Provider',
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <View>
          <Text style={styles.title}>Freelancer Portal</Text>
          <Text style={styles.subtitle}>Manage your freelance business</Text>
        </View>
