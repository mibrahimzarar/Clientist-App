      ...
      <View style={styles.actionsSection}>
        ...
        <View style={styles.actionsGrid}>
          <TouchableOpacity
            ...
            onPress={() => router.push(`/(verticals)/travel-agent/clients/${id}/travel`)}
          >
          ...
          <TouchableOpacity
            style={styles.actionButton}
            onPress={() => router.push(`/(verticals)/travel-agent/clients/${id}/visa`)}
          >
          ...
          <TouchableOpacity
            style={styles.actionButton}
            onPress={() => router.push(`/(verticals)/travel-agent/clients/${id}/followups`)}
          >
